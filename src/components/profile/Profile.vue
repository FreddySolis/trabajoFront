...
<div>
    ...
    <div class="datos" style="text-align: center;">
        ...
        <div style="margin:4%;">
            <input style="font: 200% sans-serif;" type="text" v-if="editName" v-model="user.name">
        ...
        <div style="margin:4%;">
            <input style="font: 200% sans-serif;" type="text" v-if="editEmail" v-model="user.email">
        ...
        <div style="margin:4%;" v-for="tarjeta in tarjetas" :key="tarjeta.id" >
            ...
            <button class="btn btn-danger" style="margin-top:-1%" @click="eliminar()" v-if="im"><i class="fas fa-trash-alt"></i></button>
            <br>
        </div>
        <div style="margin:4%;">
